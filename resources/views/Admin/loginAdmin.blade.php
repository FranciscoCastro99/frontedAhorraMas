    ...
    <div class="w-screen h-screen bg-white sm:bg-gray-20 relative flex m-0 p-0">
        ...
        <div class="py-6 relative w-full h-screen sm:w-7/12 md:w-6/12 lg:w-4/12 m-auto">
            <div class="bg-white rounded py-2 px-6 flex flex-col justify-center">
                <div class="mb-4">
                    <h1 class="text-center font-sans font-bold pt-4 pb-8">INICIAR SESIÓN ADMIN</h1>
                ...
                <a href="" class="hover:text-blue-500 hover:underline text-center">¿Olvidaste tu contraseña?</a>
            </div>
            ...
            <div class="bg-white rounded mt-2 pb-2 px-6 flex flex-col justify-center">
                ...
                <span class="text-center">¿No tienes una cuenta? <a class="font-bold text-[#B0D892] hover:underline hover:text-green-500" href="{{ route('registroCreate') }}">Regístrate aquí</a></span>
            </div>
        </div>
